<%-- 
    Document   : members
    Created on : Feb 23, 2023, 7:54:23 PM
    Author     : Yash
--%>
...
<!--                            <li>
                    ...
                    <div class="col py-3 bgi">
                        ...
                        <div class="container contents">
                            <div class="members ">
                                <% for (int j = 0; j < i; j++) {%>
                                <div class="container card cst rounded-3 mb-5 mt-5" style="width: 100%;">
                                    <div class=" card-body ">
                                        ...
                                        <div class="container card-text row"> <hr class="dropdown-divider pb-3">
                                            <div class="col-md-4">
                                                ...
                                                <div class="row">Gender: <%=gender[j]%> </div>
                                                <div class="row">Martial: <%=martial[j]%></div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="row">DOB: <%=dob[j]%></div>
                                                <div class="row">Age: <%=age[j]%></div>
                                                <div class="row">City: <%=city[j]%></div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="row">District: <%=district[j]%></div>
                                                <div class="row">State: <%=state[j]%></div>
                                                <div class="row">Pincode: <%=pincode[j]%></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
